...
This is a demo script with the bare-bones steps you need to https://todo[create a Gatsby app, deploy it to Netlify, and add a section that requires Okta for authentication].
